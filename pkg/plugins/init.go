...
func Init(cfg config.Config) (loadedPlugin map[string]Plugin, plugins []shared_models.Plugin, actionPlugins []shared_models.Plugin, endpointPlugins []shared_models.Plugin) {
	...
	mandatoryPlugins := []config.PluginConfig{
		{Name: "collect_data", Version: "v1.4.0"},
		// {Name: "actions_check", Version: "v1.3.0"},
		// {Name: "pattern_check", Version: "v1.3.0"},
		// {Name: "log", Version: "v1.3.0"},
		// {Name: "wait", Version: "v1.3.0"},
		// {Name: "interaction", Version: "v1.3.0"},
		// {Name: "ping", Version: "v1.4.0"},
		// {Name: "port_checker", Version: "v1.3.0"},
		// {Name: "step_analysis", Version: "v1.1.0"},
	}
